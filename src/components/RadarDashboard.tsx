...
export function RadarDashboard({ initialSearches = demoSearches, initialOffers = demoOffers, demoMode = false }: { initialSearches?: Search[]; initialOffers?: Offer[]; demoMode?: boolean }) {
